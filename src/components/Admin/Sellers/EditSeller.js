...
function EditSeller() {
  ...
  useEffect(() => {
    ...
    let getUserData = async () => {
      await axios
        .get(`http://localhost:5000/admin/sellers/edit/${id}`,{
          headers: {
            token: token,
          }
        })
 ...
 const handlePhoto = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formdata.country === "null") {
      ...
      await axios.put(`http://localhost:5000/admin/sellers/update/`, fd, {
          headers: {
            token: token,
