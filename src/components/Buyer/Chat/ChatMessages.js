...
function ChatMessages() {
  ...
  let { id } = useParams();
    ...
    channel.bind('inserted', function(newMessage) {
      if(user_id == newMessage.buyer_id && id == newMessage.seller_id){
  ...
  useEffect(() => {
    let getSellerData = async () => {
      await axios
        .get(`http://localhost:5000/buyer/chat/seller/${id}`, {
          headers: {
            token: token,
          },
        })
    ...
    getSellerData();
      ...
      await axios
        .get(`http://localhost:5000/buyer/chat/avatar`, {
          headers: {
            token: token,
          },
        })
    ...
    getBuyerData();
      ...
      await axios
        .get(`http://localhost:5000/buyer/chat/messages/${id}`,{
          headers: {
            token: token,
          },
        })
  ...
  e.preventDefault()
  axios.post('http://localhost:5000/buyer/chat/messages/new',
  {
    message: input,
    seller_id:id,
  },{
        ...
        <div className="col-7 col-md-8 chat">
          <div className="card chat_card">
            <div className="card-body welcome_card_body">     
                ...
                <p>Hare you can Chat with Sellers</p>
            </div>
          </div>   
        </div>
        :<div className="col-7 col-md-8 chat">
            ...
            <div className="card-header card_header msg_head">
              <div className="d-flex bd-highlight">
                ...
                <div className="user_info">
                  ...
                  <Link
                    to={`/buyer/services/seller-profile/${seller.id}`}
                  >
